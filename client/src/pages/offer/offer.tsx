...
function Offer() {
  ...
  const [offer, setOffer] = useState<FullOffer>()

  useEffect(() => {
    apiClient.get<OfferList[]>("/offers")
    .then(response => setOffers(response.data));
  }, [])

  useEffect(() => {
    apiClient.get<FullOffer>(`/offers/${params.id}`)
              ...
              <div className="offer__wrapper">
                ...
                <div className="offer__host">
                  ...
                  <div className="offer__host-user user">
                    ...
                    <span
                        className="offer__user-status">{offer.host.isPro ? 'PRO' : 'Normal'}</span>
                  </div>
